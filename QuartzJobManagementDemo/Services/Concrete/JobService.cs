        ...
        public async Task<List<CustomJob>> GetAllAsync()
        {
            ...
            foreach (var name in groupNames)
            {
                ...
                foreach (var jobKey in jobKeys)
                {
                    ...
                    {
                        Name = jobKey.Name,
                        CreatedBy = jobDetail.JobDataMap[MessagePrinterJobParameters.CreatedBy]?.ToString() ?? string.Empty,
                        Text = jobDetail.JobDataMap[MessagePrinterJobParameters.Message]?.ToString() ?? string.Empty,
